...
# current/live df
su = 'https://docs.google.com/spreadsheets/d/1EySH2eZEXaYlWn5y43V_pBU47LRv9ebCt8TkcwqpaX0/edit#gid=0'
df_live = domo.load_gsheet(su).dropna(subset='Phone Number')

# new rows only
df_new = pd.merge(df3, df_live, left_on='id', right_on='Order ID', how="outer", indicator=True)
df_new = df_new[df_new['_merge'] == 'left_only']

# append new rows to live df
domo.append_gsheet(su, df_new.loc[:,:'threshold'])
